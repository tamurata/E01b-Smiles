...
arcade.draw_ellipse_filled(365,325,15,25,open_color.black)
arcade.draw_circle_filled(435,337,3,open_color.gray_2)
arcade.draw_circle_filled(370,337,3,open_color.gray_2)

#(x,y,width,height,color,start_degrees,end_degrees,border_thickness)
arcade.draw_arc_outline(397,300,60,50,open_color.black,190,350,4)
